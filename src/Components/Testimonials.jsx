...
const Testimonials = () => {
  return (
    <section className="my-1 dark:bg-gray-100 dark:text-gray-800">
      <div className="container border-b-2 flex flex-col items-center mx-auto md:p-10 md:px-12">
      ...
      >
        <SwiperSlide>
          <div className="container flex flex-col w-full max-w-lg mx-auto divide-y rounded-md dark:divide-gray-300 dark:bg-gray-50 dark:text-gray-800">
